...
wchar_t* GetSignatureFromWebService() {
    ...
    //the below code will fetch the auth token (aka JWT Token, JWT Signature) from a hosted generator based on  https://github.com/zoom/meetingsdk-auth-endpoint-sample
    std::string url = "";
